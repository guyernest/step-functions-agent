...
const PmcpWasmClientFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_pmcpwasmclient_free(ptr >>> 0, 1));
...
export class PmcpWasmClient {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        PmcpWasmClientFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_pmcpwasmclient_free(ptr, 0);
    }
    /**
    ...
    constructor(server_url) {
        ...
        const ret = wasm.pmcpwasmclient_new(ptr0, len0);
        this.__wbg_ptr = ret >>> 0;
        PmcpWasmClientFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     */
    initialize() {
        const ret = wasm.pmcpwasmclient_initialize(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     */
    list_tools() {
        const ret = wasm.pmcpwasmclient_list_tools(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     * @returns {Promise<any>}
     */
    call_tool(tool_name, _arguments) {
        const ptr0 = passStringToWasm0(tool_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.pmcpwasmclient_call_tool(this.__wbg_ptr, ptr0, len0, _arguments);
        return ret;
    }
    /**
     ...
     */
    list_resources() {
        const ret = wasm.pmcpwasmclient_list_resources(this.__wbg_ptr);
        return ret;
    }
    /**
    ...
    read_resource(uri) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.pmcpwasmclient_read_resource(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    /**
     ...
     */
    list_prompts() {
        const ret = wasm.pmcpwasmclient_list_prompts(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     * @returns {Promise<any>}
     */
    get_prompt(name, _arguments) {
        const ptr0 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.pmcpwasmclient_get_prompt(this.__wbg_ptr, ptr0, len0, _arguments);
        return ret;
    }
}
if (Symbol.dispose) PmcpWasmClient.prototype[Symbol.dispose] = PmcpWasmClient.prototype.free;

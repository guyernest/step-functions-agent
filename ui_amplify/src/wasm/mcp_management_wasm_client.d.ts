...
export class PmcpWasmClient {
   ...
   */
  get_prompt(name: string, _arguments: any): Promise<any>;
}
...
export interface InitOutput {
  ...
  readonly pmcpwasmclient_list_resources: (a: number) => any;
  readonly pmcpwasmclient_read_resource: (a: number, b: number, c: number) => any;
  readonly pmcpwasmclient_list_prompts: (a: number) => any;
  readonly pmcpwasmclient_get_prompt: (a: number, b: number, c: number, d: any) => any;

...
class CloudWatchInterface:
    ...
    def get_service_graph(self, start_time: int, end_time: int, group_name: str = None) -> dict:
        """Get the X-Ray service graph for a given time range."""
        try:
            ...
            return {
                'error': f"Failed to get X-Ray service graph: {str(e)}"
            }
    ...
    match tool_name:
        ...
        case 'get_service_graph':
            ...
            if not all(param in tool_input for param in required_params):
                ...
                result = json.dumps({
                    'service_graph': cloudwatch.get_service_graph(
...
if __name__ == "__main__":
    ...
    # Test event for get_service_graph
    test_event_service_graph = {
        "name": "get_service_graph",
        "id": "service_graph_unique_id",
        "input": {
    ...
    print("\nTesting get_service_graph:")
    response_service_graph = lambda_handler(test_event_service_graph, None)
    print(response_service_graph)
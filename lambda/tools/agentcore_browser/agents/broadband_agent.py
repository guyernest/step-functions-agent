...
from nova_act_agent.base_agent import NovaActAgent, BroadbandCheckerAgent, AuthenticatedBroadbandCheckerAgent
...
def handle_broadband_check(body: Dict[str, Any], credentials: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        # Execute broadband check with credentials
        # Credentials should contain: username, password for BT portal
        portal_credentials = {

...
import { listAgentsFromRegistry } from './backend/function/listAgentsFromRegistry/resource.js';
import { listToolsFromRegistry } from './backend/function/listToolsFromRegistry/resource.js';
import { startAgentExecution } from './backend/function/startAgentExecution/resource.js';
...
// [backend.listStepFunctionExecutions, backend.getStepFunctionExecution].forEach(func => {
